    ...
    public ServicioPersistenciaMock()
    {
        if (vendedores == null)
        {
            ...
            for (int e = 1; e < 3; e++) {
                ...
                ofer.setIdOferta(e);
                ofer.setLoginUsuarioOfertante(vendedores.get(e).getNombres());
                ofer.setOferta(ra.nextInt(199999)+1000000);
                ofer.setReferenciaMueble(muebles.get(e).getReferencia());
                ofertas.add(ofer);
            }
            //ofertas.add(new Oferta(1,"cliente", 1L,2.1));
